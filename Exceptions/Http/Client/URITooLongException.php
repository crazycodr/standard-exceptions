...
class URITooLongException extends ClientErrorException implements InvalidDataTag
{
     ...
     */
    public const HTTP_CODE = 414;

    /**
     * Returns the HTTP error message for that exception.
     */
    public const HTTP_MESSAGE = 'URI Too Long: The server is refusing to process a request because the requested URI was too long and response might not be accurate.';
}

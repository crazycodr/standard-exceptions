 ...
 * you force a (string) to be received but receive a (int), throw a \Logic\IllegalArgumentTypeException instead.
 *
...
class InvalidStringException extends InvalidValueException
{
    public function __construct(
        $message = 'The data is not a valid string for this operation',
        $code = 0,
        $previous = null
    ) {

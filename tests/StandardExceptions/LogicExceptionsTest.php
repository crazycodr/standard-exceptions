...
class LogicExceptionsTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        try {
            throw new \StandardExceptions\LogicExceptions\IllegalArgumentTypeException('Test message passed', 92837,
    ...
    {
        try {
            throw new \StandardExceptions\LogicExceptions\IllegalValueException('Test message passed', 92837,
                $previousException = new \Exception('test'));

...
class ExceptionsTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function providesConstructorTestClasses()
    {
        return [
            ...
            [\Exceptions\Http\Client\LockedTag::class],
            ...
            [\Exceptions\Http\Client\TooManyRequestsTag::class],
            [\Exceptions\Http\Client\UnauthorizedException::class],
            [\Exceptions\Http\Client\UnavailableForLegalReasonsTag::class],
            ...
            [\Exceptions\IO\Filesystem\DirectoryNotReadableTag::class],
            [\Exceptions\IO\Filesystem\DirectoryNotWritableTag::class],
            [\Exceptions\IO\Filesystem\FileAlreadyExistsException::class],
            [\Exceptions\IO\Filesystem\FileNotFoundException::class],
            [\Exceptions\IO\Filesystem\FileNotReadableTag::class],
            [\Exceptions\IO\Filesystem\FileNotWritableTag::class],
            ...
            [\Exceptions\IO\Network\ConnectionRefusedTag::class],
